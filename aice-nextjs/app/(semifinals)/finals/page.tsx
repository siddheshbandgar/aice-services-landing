...
const TOPMATE_LINK = "https://topmate.io/ajinkya_hazare/1990750/pay?utm_source=public_profile&utm_campaign=ajinkya_hazare";
const WHATSAPP_LINK = "https://wa.me/918551914432?text=Hi%2C%20I%20have%20a%20question%20about%20the%20Finals%20ticket%20alert";
  ...
  return (
    <main className="min-h-screen bg-white text-gray-900 selection:bg-orange-200">
        ...
        <div className="relative mx-auto grid max-w-6xl gap-6 px-4 pb-10 pt-8 sm:px-6 sm:py-14 lg:grid-cols-[1.3fr_1fr] lg:items-center lg:gap-10 lg:py-16">
          ...
          <div>
            ...
            <h1 className="mt-2 text-5xl font-black leading-none tracking-tight sm:text-7xl">
              ...
              <span className="bg-gradient-to-r from-black via-gray-300 to-white bg-clip-text text-transparent">NZ</span>
            </h1>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-green-300/50 transition-transform hover:scale-110 active:scale-95"
