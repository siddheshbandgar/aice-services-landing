    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-gray-50">
        <form onSubmit={login} className="w-full max-w-sm rounded-2xl border bg-white p-8 shadow-lg">
          <h1 className="text-xl font-bold text-gray-900">Finals Admin</h1>
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      <header className="border-b bg-white px-6 py-4">
        <div className="mx-auto flex max-w-6xl items-center justify-between">
          <h1 className="text-lg font-bold">Finals Admin</h1>
      ...
      <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6">
        ...
        {debug && (
          <div className="mt-4 rounded-2xl border border-dashed border-red-300 bg-red-50 p-5">
            ...
            <p className="mt-1 text-xs text-red-500">If tickets are live, it WILL send real emails to all active subscribers.</p>
