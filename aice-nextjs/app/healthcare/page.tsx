        ...
        <main>
            <section className="vertical-hero">
                <div className="container">
                    ...
                    <p>Transform patient care with AI-powered support systems that handle appointments, answer queries, and guide patients through their healthcare journey.</p>
            ...
            <section className="coming-soon">
                ...
                <p>Experience our AI-powered patient support system in action.</p>
